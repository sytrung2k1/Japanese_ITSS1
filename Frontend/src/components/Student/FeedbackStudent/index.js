...
function FeedbackStudent() {
  return (
    <>
      ...
      <div className={cx("feedback")}>
        <div className={cx("feedback_detail")}>
          ...
          <div className={cx("fb_detail")}>
            <span className={cx("fb_name")}>Namee</span>
            <br />
            ...
            <p>
              ...
              dolorum odit nam autem ipsa voluptatum sed aliquid sequi quas
              aperiam maxime obcaecati eos consequatur quis consectetur
              repellendus, ea velit. Minima.
            </p>
          </div>
        </div>
        <div className={cx("feedback_detail")}>
          <img
            src="https://znews-photo.zingcdn.me/w1200/Uploaded/qhj_yvobvhfwbv/2018_07_18/Nguyen_Huy_Binh1.jpg"
            alt="avatar"
            className={cx("fb_avatar")}
          />
          <div className={cx("fb_detail")}>
      ...
      <script
        src="https://kit.fontawesome.com/f1f646c5e0.js"
