    ...
    <>
      <div className={cx("wrapper")}>
        ...
        <div className={cx("left")}>
          ...
          <p className={cx("p-profile")}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            Proinultrices posuere hendrerit. Aenean vitae fringilla justo,
            vitaeiaculis lacus. Suspendisse euismod, magna et molestie congue,
            sapien mi aliquet ipsumm
          </p>
